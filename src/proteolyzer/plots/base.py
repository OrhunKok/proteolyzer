"""Base plotting helpers and abstractions.

This module defines base classes and small helper functions that are shared
across multiple plotting implementations. It centralizes styling, figure
creation, and common layout code so derived plot classes can remain focused
on data mapping.
