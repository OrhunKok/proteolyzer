"""Tests for the tools/unimod maintainer script.

Building the database needs the network, so these work against a hand-made
SQLite file with the same shape as the real one.
"""
...
from tools.unimod import UnimodDBLoader, UniModProcessor  # noqa: E402
